...
function unoGame(config){
    ...
    function processAiTurns(message, game){
        ...
        while (nextPlayer.isAi){
            ...
            botBrain.play(nextPlayer.hand, game.currentCard, (color, value) => aiPlay(game, color, value), () => aiDraw(game));
    ...
    function aiPlay(game, color, value){
    ...
    function aiDraw(game){
        //TODO: make it so the call returns the new hand, and integrate into do/while loop on the AI side.
        //  This will help prevent stack overflows when a large number of cards need to be drawn.
        
        //Add card to hand
        //Call AI play with new hand
        console.log('AI Drawed');
    }
